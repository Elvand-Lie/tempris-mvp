...
export default function Strike() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 min-w-0 overflow-x-hidden">
      {notification && (
        ...
        <div className="flex items-center gap-2 flex-wrap justify-end min-w-0">
          ...
          <div className="relative">
            <input
              ...
              className="bg-background border border-border rounded-lg px-3 py-2 text-sm outline-none w-full sm:w-[220px] focus:border-primary-500 transition-colors"
          ...
          {signedAuth && (
            <button
              ...
              title={`Re-run ${signedAuth.target_name}`}
            >
              <Target size={14} />
              Re-run last signed
            </button>
      ...
      <div className="flex flex-col xl:flex-row gap-6 min-w-0">
        ...
        {/* MITRE ATT&CK Matrix */}
        <div className="flex-1 min-w-0 glass-panel p-6 overflow-hidden">
