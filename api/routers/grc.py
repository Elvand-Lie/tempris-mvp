...
from models import GrcState, GrcSignoff, ControlEvidence
...
def get_policy(policy_id: str, user=Depends(get_current_user)):
...
def update_policy(policy_id: str, payload: PolicyUpdate, user=Depends(require_role("Superadmin", "Admin"))):
